...
status = True
symbol_list_all = ['SHSZ.000300','SZSE.000002','SZSE.000333','SHSE.601318','SHSE.600585','SHSE.600508','SHSE.600660','SHSE.603288','SHSE.512880']
symbol_list = ['SHSE.000300','SZSE.000002','SZSE.000333','SHSE.601318','SHSE.512880']
frequency_1m = '60s'
frequency_1h = '3600s'
count = 1
...
while status:
    while current_time < '09:00:00' or current_time > '15:10:00':
        print('****' + current_time + ': 非交易时间。')
        time.sleep(3600)
        current_time = dt.now().strftime('%H:%M:%S')

    while current_time < '09:30:00' and current_time > '09:00:00': # 早盘前, 判断非交易时间则休眠并循环
    ...
    while current_time >= '09:30:00' and current_time <= '15:01:00':
        if current_time >= '11:30:00' and current_time <= '12:59:00':
            ...
            if current_time[:5] in ['10:30','11:30','14:00','15:00']:
                ...
                td.update_calc_data(symbol_list) # 计算策略及其交易信号, 并插入td_kd数据表

            #2. 实时更新交易信号
            print('****交易时间: ' + current_time + '***********************************')
            if current_time[:5] in ['09:30','10:30','13:00','14:00']:
                signal_list = td.get_td_signal_h(symbol_list)
            else:
                signal_list = td.get_td_signal(symbol_list)
            print(signal_list)
